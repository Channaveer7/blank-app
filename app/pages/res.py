...
if submit_button:
    try:
        llm = ChatGroq(
            temperature=0,
            groq_api_key=os.getenv("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"),
...
if st.session_state.generated_response:
    ...
    st.text_area("",value=st.session_state.generated_response, height=300, disabled=True)
